...
class MyGrid(GridLayout):
    ...
    def pressed2(self,instance):
        xlsx_file = Path("/home/iiit/Downloads/covid19","data6.xlsx")
    ...
    def pressed3(self,instance):
        xlsx_file = Path("/home/iiit/Downloads/covid19","data8.1.xlsx")
        wb_obj = openpyxl.load_workbook(xlsx_file)
        sheet = wb_obj.active


        xlsx_file1 = Path("/home/iiit/Downloads/covid19","data8.2.xlsx")
        wb_obj1 = openpyxl.load_workbook(xlsx_file1)
        sheet1 = wb_obj1.active


        xlsx_file2 = Path("/home/iiit/Downloads/covid19","data8.3.xlsx")
    ...
    def pressed6(self,instance):
        ...
        loc = ("/home/iiit/Downloads/covid19/data7.1.xlsx") 
